...
CREATE TABLE `user_comments` (
  ...
  KEY `FKtct0inyni1e7doqwdxi84qr9u` (`user_id`),
  KEY `FKcp1co848i58jhgr08u2mxu55g` (`query_id`),
  CONSTRAINT `FKcp1co848i58jhgr08u2mxu55g` FOREIGN KEY (`query_id`) REFERENCES `user_query` (`query_id`),
  CONSTRAINT `FKtct0inyni1e7doqwdxi84qr9u` FOREIGN KEY (`user_id`) REFERENCES `user_details` (`user_id`)
